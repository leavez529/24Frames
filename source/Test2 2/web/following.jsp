                    ...
                    <div class="row">
                        <div class="sixteen wide tablet thirteen wide computer column">
                            <div class="ui segments">
                                ...
                                <div class="ui segment">
                                    <div class="ui items">
                                        <c:forEach var="f" items="${followedList}">
                                            <div class="ui divider"></div>
                                            <div class="item">
                                                <a class="ui tiny circular image">
                                                    <img src="${f.avator}" alt="label-image" />
                                                </a>
                                                <div class="content">
                                                    <a class="header" href="/mytags?id=${f.id}">${f.username}</a>
                                                    <div class="description">
                                                        <p>${f.intro}
                                                            <c:choose>
                                                                <c:when test="${f.gender == '男'}">
                                                                    <a class="ui blue mini label">男</a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a class="ui red mini label">女</a>
                                                                </c:otherwise>
                                                            </c:choose>
                                                            <button onclick="cancelFollow('${f.id}')" class="ui right floated button"><i class="heart outline icon"></i>取消关注</button>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
